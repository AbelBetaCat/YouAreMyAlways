                                ...
                                public void run() {
                                    ...
                                    if (resultflag) {
                                       ...
                                       // editor.putString("password", et_register_password.getText().toString());
                                        ...
                                        Intent intent=new Intent(RegisterActivity.this, setInfomationActivity.class);
                                        intent.putExtra("phone", et_register_phone.getText().toString().trim());
                                        intent.putExtra("password", et_register_password.getText().toString().trim());
