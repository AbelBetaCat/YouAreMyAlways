...
import com.stone.app.guidingPage.GuidingPageActivity;
...
//        DataBaseManager dataBaseManager = new DataBaseManager();
    ...
    private class AnimationImpl implements Animation.AnimationListener {
        ...
        public void onAnimationStart(Animation animation) {
            welcomeImg.setBackgroundResource(R.mipmap.booting2);
...
//        if (pref.getString("phone", "").isEmpty() && pref.getString("password", "").isEmpty()) {
            //跳转到 LoginActivity，最后换成gotoLoginActivit
        // ?y
        if (pref.getBoolean("isFirstLogin", true)) {

            startActivity(new Intent(bootAnimation.this,GuidingPageActivity.class));
            //diyici登录要导引界面
        }else {

            startActivity(new Intent(bootAnimation.this, mainpageYoung.class));
//            finish();
        }
        finish();
        //        if (pref.getInt("style",5)==STYLEYOUNG) {
        //
        //        }
        //                 //   gotoLoginActivity();
//            Log.i("TAG", "没有自动登陆");
