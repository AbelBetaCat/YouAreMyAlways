...
import com.stone.app.style_old.oldMainActivity;
...
//                                        finish();
    ...
    private void gotoMainyoung() {
        ...
        Intent intent_style;
        if(getDataUtil.getStyle(phone_loginActivity.this)==STYLEYOUNG){

            intent_style=new Intent(phone_loginActivity.this, mainpageYoung.class);
        }else {
            intent_style=new Intent(phone_loginActivity.this, oldMainActivity.class);

        }
       // intent_style.putExtra("memberID",memberID);
