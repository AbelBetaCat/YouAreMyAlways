...
public class photoUploadActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private EditText et_photoinfo_note;
    ...
    private void init() {
       ...
       // et_photoinfo_note = (EditText) findViewById(R.id.et_photoinfo_note);
        ...
        if (resultCode == RESULT_OK) {
            switch (requestCode) {
                case PictureConfig.CHOOSE_REQUEST:
                    ...
                    //et_photoinfo_note.setVisibility(View.VISIBLE);
...
//                    dataBaseManager.AddImage(memberID, name,plece , adapter.getImagePath(), mydata, "", "");
                ...
                //    String note="";
//                    if ((!TextUtils.isEmpty(et_photoinfo_note.getText().toString().trim()))) {
//                        note = et_photoinfo_note.getText().toString().trim();
//
//                    }
//                    if(note.length()>200){
//                        ToastUtil.showToast(photoUploadActivity.this,"不能多于200字");
//                        finish();
//                    }
